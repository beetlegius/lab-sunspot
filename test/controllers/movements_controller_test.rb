...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { ammount: @movement.ammount, client_id: @movement.client_id, name: @movement.name } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { ammount: @movement.ammount, client_id: @movement.client_id, name: @movement.name } }
